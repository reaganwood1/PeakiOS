...
class ActiveAttemptsSectionController: ListSectionController, ListSupplementaryViewSource {
    ...
    override func cellForItem(at index: Int) -> UICollectionViewCell {
        ...
        cell.set(attemptDescription: attempt.goalChallenge.title, andDifficultyTo: "HARD", currentCompleted: attempt.currentCompleted, goalY: attempt.goalChallenge.attemptsToComplete, currentY: attempt.currentCompleted, withCellWidth: getCellWidth(), difficultyColor: attempt.goalChallenge.difficulty.color)
